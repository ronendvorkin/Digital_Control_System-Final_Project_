...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_theta_data_test is
  ...
  signal first_data_i_1_n_0 : STD_LOGIC;
  ...
  signal \mult__0_i_5_n_1\ : STD_LOGIC;
  signal \mult__0_i_5_n_2\ : STD_LOGIC;
  signal \mult__0_i_5_n_3\ : STD_LOGIC;
  signal \mult__0_i_5_n_4\ : STD_LOGIC;
  signal \mult__0_i_5_n_5\ : STD_LOGIC;
  signal \mult__0_i_5_n_6\ : STD_LOGIC;
  signal \mult__0_i_5_n_7\ : STD_LOGIC;
  signal \mult__0_i_6_n_0\ : STD_LOGIC;
  ...
  signal mult_i_1_n_2 : STD_LOGIC;
  signal mult_i_1_n_3 : STD_LOGIC;
  signal mult_i_1_n_5 : STD_LOGIC;
  signal mult_i_1_n_6 : STD_LOGIC;
  signal mult_i_1_n_7 : STD_LOGIC;
  signal mult_i_2_n_0 : STD_LOGIC;
  signal mult_i_2_n_1 : STD_LOGIC;
  signal mult_i_2_n_2 : STD_LOGIC;
  signal mult_i_2_n_3 : STD_LOGIC;
  signal mult_i_2_n_4 : STD_LOGIC;
  ...
  signal NLW_mult_P_UNCONNECTED : STD_LOGIC_VECTOR ( 47 downto 15 );
  ...
  signal \NLW_mult__1_P_UNCONNECTED\ : STD_LOGIC_VECTOR ( 47 downto 15 );
  ...
  signal NLW_mult_i_1_CO_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal NLW_mult_i_1_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \mult__0_i_5\ : label is 35;
  ...
  attribute ADDER_THRESHOLD of mult_i_1 : label is 35;
...
mult: unisim.vcomponents.DSP48E1
    generic map(
      ...
      B(16) => \^theta_data\(13),
      B(15) => \^theta_data\(13),
      B(14 downto 1) => \^theta_data\(13 downto 0),
      B(0) => '0',
      ...
      P(47 downto 15) => NLW_mult_P_UNCONNECTED(47 downto 15),
      P(14) => mult_n_91,
      P(13) => mult_n_92,
      P(12) => mult_n_93,
      P(11) => mult_n_94,
...
\mult__0\: unisim.vcomponents.DSP48E1
    generic map(
      ...
      A(16) => \mult__0_i_2_n_4\,
      A(15) => \mult__0_i_2_n_5\,
      A(14) => \mult__0_i_2_n_6\,
      A(13) => \mult__0_i_2_n_7\,
      A(12) => \mult__0_i_3_n_4\,
      A(11) => \mult__0_i_3_n_5\,
      A(10) => \mult__0_i_3_n_6\,
      A(9) => \mult__0_i_3_n_7\,
      A(8) => \mult__0_i_4_n_4\,
      A(7) => \mult__0_i_4_n_5\,
      A(6) => \mult__0_i_4_n_6\,
      ...
      P(17) => \mult__0_n_88\,
      P(16) => \mult__0_n_89\,
      P(15 downto 0) => \^count1\(15 downto 0),
...
\mult__0_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\mult__0_i_5\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \mult__0_i_5_n_0\,
      CO(2) => \mult__0_i_5_n_1\,
      CO(1) => \mult__0_i_5_n_2\,
      CO(0) => \mult__0_i_5_n_3\,
      CYINIT => count_reg(0),
      DI(3 downto 0) => B"0000",
      O(3) => \mult__0_i_5_n_4\,
      O(2) => \mult__0_i_5_n_5\,
...
\mult__0_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\mult__1\: unisim.vcomponents.DSP48E1
    generic map(
      ...
      P(47 downto 15) => \NLW_mult__1_P_UNCONNECTED\(47 downto 15),
      P(14) => \mult__1_n_91\,
      P(13) => \mult__1_n_92\,
      P(12) => \mult__1_n_93\,
      P(11) => \mult__1_n_94\,
...
mult_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => \mult__1_n_105\,
      DI(0) => '0',
      O(3 downto 0) => \^count1\(19 downto 16),
...
\mult_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => \mult__1_n_101\,
      DI(0) => \mult__1_n_102\,
      O(3 downto 0) => \^count1\(23 downto 20),
...
\mult_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => \mult__1_n_97\,
      DI(0) => \mult__1_n_98\,
      O(3 downto 0) => \^count1\(27 downto 24),
...
\mult_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => \mult__1_n_93\,
      DI(0) => \mult__1_n_94\,
      O(3 downto 0) => \^count1\(31 downto 28),
...
mult_i_1: unisim.vcomponents.CARRY4
     port map (
      CI => mult_i_2_n_0,
      CO(3 downto 2) => NLW_mult_i_1_CO_UNCONNECTED(3 downto 2),
      CO(1) => mult_i_1_n_2,
      CO(0) => mult_i_1_n_3,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => NLW_mult_i_1_O_UNCONNECTED(3),
      O(2) => mult_i_1_n_5,
      O(1) => mult_i_1_n_6,
      O(0) => mult_i_1_n_7,
      S(3) => '0',

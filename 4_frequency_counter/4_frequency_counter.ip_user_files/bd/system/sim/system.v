...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=22,numReposBlks=22,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=2,da_clkrst_cnt=1,da_ps7_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  wire [31:0]max_min_calculator_v_0_addr;
  wire [16:0]max_min_calculator_v_0_vpp;
  wire [3:0]max_min_calculator_v_0_write_enable;
  ...
  system_blk_mem_gen_1_0 blk_mem_gen_1
       (.addra(max_min_calculator_v_0_addr),
        ...
        .dina({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,max_min_calculator_v_0_vpp}),
        ...
        .wea(max_min_calculator_v_0_write_enable),
  ...
  system_ila_0_0 ila_0
       (.clk(processing_system7_0_FCLK_CLK0),
        ...
        .probe1(max_min_calculator_v_0_vpp),
  ...
  system_max_min_calculator_v_0_0 max_min_calculator_v_0
       (.addr(max_min_calculator_v_0_addr),
        .clk(processing_system7_0_FCLK_CLK0),
        .data_in(xlslice_0_Dout),
        .resetn(rst_ps7_0_125M_peripheral_aresetn),
        .theta_data(theta_data_test_0_theta_data),
        .vpp(max_min_calculator_v_0_vpp),
        .write_enable(max_min_calculator_v_0_write_enable));

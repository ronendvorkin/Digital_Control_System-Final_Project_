...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=20,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=3,da_clkrst_cnt=6,da_ps7_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  wire [31:0]max_min_calculator_0_addr;
  wire [16:0]max_min_calculator_0_vpp;
  wire [3:0]max_min_calculator_0_write_enable;
  wire [31:0]max_min_calculator_1_addr;
  wire [16:0]max_min_calculator_1_vpp;
  wire [3:0]max_min_calculator_1_write_enable;
  ...
  wire [31:0]theta_data_test_0_theta_data;
  wire theta_data_test_0_theta_valid;
  wire [31:0]tp_0_theta_output;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x42000000 32 > system blk_mem_gen_1" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  system_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra(max_min_calculator_0_addr),
        ...
        .dina({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,max_min_calculator_0_vpp}),
        ...
        .wea(max_min_calculator_0_write_enable),
        .web(axi_bram_ctrl_0_BRAM_PORTB_WE));
  system_blk_mem_gen_1_0 blk_mem_gen_1
       (.addra(max_min_calculator_1_addr),
        ...
        .dina({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,max_min_calculator_1_vpp}),
        ...
        .wea(max_min_calculator_1_write_enable),
  ...
  system_dds_compiler_0_0 dds_compiler_0
       (.aclk(axis_red_pitaya_adc_0_adc_clk),
        ...
        .s_axis_phase_tdata(theta_data_test_0_theta_data),
        .s_axis_phase_tvalid(theta_data_test_0_theta_valid));
  system_max_min_calculator_0_1 max_min_calculator_0
       (.addr(max_min_calculator_0_addr),
        .clk(axis_red_pitaya_adc_0_adc_clk),
        .data_in(dds_compiler_0_m_axis_data_tdata[13:0]),
        .resetn(rst_ps7_0_125M_peripheral_aresetn),
        .theta_data(theta_data_test_0_theta_data),
        .vpp(max_min_calculator_0_vpp),
        .write_enable(max_min_calculator_0_write_enable));
  system_max_min_calculator_1_0 max_min_calculator_1
       (.addr(max_min_calculator_1_addr),
        .clk(axis_red_pitaya_adc_0_adc_clk),
        .data_in(xlslice_0_Dout),
        .resetn(rst_ps7_0_125M_peripheral_aresetn),
        .theta_data(tp_0_theta_output),
        .vpp(max_min_calculator_1_vpp),
        .write_enable(max_min_calculator_1_write_enable));
  (* BMM_INFO_PROCESSOR = "arm > system axi_bram_ctrl_0 system axi_bram_ctrl_1" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  system_theta_data_test_0_0 theta_data_test_0
       (.clk(axis_red_pitaya_adc_0_adc_clk),
        .resetn(rst_ps7_0_125M_peripheral_aresetn),
        .theta_data(theta_data_test_0_theta_data),
        .theta_valid(theta_data_test_0_theta_valid));
  system_tp_0_0 tp_0
       (.clk(axis_red_pitaya_adc_0_adc_clk),
        .theta_data(theta_data_test_0_theta_data),
        .theta_output(tp_0_theta_output));
